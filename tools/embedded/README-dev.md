# llama-embedded Development Documentation

This document provides an in-depth technical overview of `llama-embedded`, intended for maintainers and contributors.

If you are an end user consuming `llama-embedded` as a product, please refer to the main [README](./README.md) instead.
